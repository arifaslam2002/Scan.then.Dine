...
const AllergySelection = () => {
  ...
  const [tableNumber, setTableNumber] = useState(
    localStorage.getItem("tableNumber") || "T-05",
  );
  ...
  const handleContinue = () => {
    localStorage.setItem("customerAllergies", JSON.stringify(selected));

    localStorage.setItem("noAllergies", JSON.stringify(noAllergies));
    ...
    <div className="min-h-screen bg-[#f7f7f5] text-[#171717]">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-32 pt-10 sm:px-8">
        ...
        <div className="text-center">
          ...
          <p className="text-sm font-semibold text-orange-500">Step 1 of 3</p>
          ...
          <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-gray-500 sm:text-base">
            Tell us what you need to avoid. We'll use this information to hide
            foods containing those ingredients from your menu.
          </p>
        </div>
          ...
          {allergies.map((allergy) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-4 text-sm font-semibold">{allergy.name}</p>
        ...
        >
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold">I don't have any allergies</p>
        ...
        <div className="mt-6 flex gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-amber-800/80">
              Ingredients and preparation methods may vary. If you have a
